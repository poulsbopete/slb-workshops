...
- type: text
  contents: |-
    ...
    <iframe src="https://slb-workshops.vercel.app/slides/oneoff-ai-ml/" width="100%" height="1400" frameborder="0" style="display:block;width:100%;min-width:100%;height:1400px;border:0;border-radius:8px"></iframe>
    </div>
tabs:
- id: 4nbmvhjpwo3w
